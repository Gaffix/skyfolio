...
module.exports={readGoals:()=>readJson('goals.json'),writeGoals:data=>writeJson('goals.json',data),readNotebook:()=>readJson('notebook.json'),writeNotebook:data=>writeJson('notebook.json',data),readIronpath:()=>readJson('ironpath.json'),writeIronpath:data=>writeJson('ironpath.json',data)};
